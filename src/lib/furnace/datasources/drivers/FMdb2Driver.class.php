...
class FMdb2Driver extends FDatasourceDriver {
    ...
    protected function interpretFQuery($query) {
        ...
        $this->query_meta['objectType']      = Furnace::standardizeName($query->getTargetObjectType());
        $this->query_meta['objectTypeTable'] = Furnace::standardizeTableName($query->getTargetObjectType());
