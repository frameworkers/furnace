...
abstract class FDatasourceDriver {
    ...
    /**
     * Process an {@link Query} object and return an {@link Result}
     * 
     * Implementations of this function should provide the logic necessary to convert a 
     * standard {@link Query} object into one (or more) native datasource
     * queries. Furthermore, it must package the response from the
     * underlying layer as an {@link Result}, which should be returned
     * to the callee.
     * 
