...
use org\crawwler\tadpole as Tadpole;
/*
 ...
 *  TadpoleEngine
 */
class FPageTemplate extends Tadpole\TadpoleEngine {
					...
					if ($count == $segmentCountMinusOne) {
						...
						if ($bIsObject) {
							...
							if (is_callable(array($flashlight,$privateMethod))) {
							    ...
							    if (is_object($result) && $result instanceof \org\frameworkers\furnace\core\ObjectCollection) {
