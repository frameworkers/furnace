...
class ModelController extends Controller {
	...
	public function __construct() {
		...
		$this->setTitle("Furnace :: Data Modeling");
	}
	...
	public function summary() {
		$this->internalRedirect("/_furnace/model");
	}
	...
	public function saveModel() {
		...
		$this->flash("model changes saved. Don't forget to "
			."<a class=\"ff\" href=\"/_furnace/model/generate/\">regenerate your model objects</a>!");
		$this->redirect("/_furnace/model/");
	}
...
CREATE TABLE `app_accounts` (
  ...
  `created` datetime NOT NULL COMMENT 'When the account was created',
  `modified` datetime NOT NULL COMMENT 'When the account was last modified',
  `lastLogin` datetime NOT NULL COMMENT 'The last time the account was logged in',
  PRIMARY KEY  (`objId`),
...
END;
			...
			$this->redirect("/_furnace/model/editObject/{$objectType}");
		}
	}
	...
	public function addGenericAttribute() {
		if ($this->form) {
			...
			$this->redirect("/_furnace/model/editObject/{$objectClass}");
		}
	}
	...
	public function addParent() {
		if ($this->form) {
			...
			$this->redirect("/_furnace/model/editObject/{$this->form['objectClass']}");
		}
	}
